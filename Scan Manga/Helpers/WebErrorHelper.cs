...
public static class WebErrorHelper
{
    ...
    public static WebErrorInfo GetErrorMessage(int errorCode)
    {
        return errorCode switch
        {
            -1000 => new(
                "URL invalide (-1000)",
                "L'adresse de la page est incorrecte."
            ),
            -1001 => new(
                "Délai dépassé (-1001)",
            ...
            -1003 => new(
                "Serveur introuvable (-1003)",
                "Impossible de trouver le serveur demandé."
            ),
            -1004 => new(
                "Impossible de se connecter (-1004)",
                "Le serveur est inaccessible pour le moment."
            ),
            -1005 => new(
                "Connexion interrompue (-1005)",
                "La connexion réseau a été interrompue."
            ),
            // --- Redirections / Accès ---
            -1007 => new(
                "Redirection refusée (-1007)",
                "Trop de redirections ont été détectées."
            ),
            -1009 => new(
                "Aucune connexion Internet (-1009)",
                "Vous n'êtes pas connecté à Internet. Vérifiez votre connexion réseau."
            ),
            -1012 => new(
                "Authentification requise (-1012)",
                "Une authentification est nécessaire pour accéder à cette ressource."
            ),
            -1013 => new(
                "Accès refusé (-1013)",
            ...
            -1100 => new(
                "Page introuvable (-1100)",
                "La page demandée est introuvable ou a été déplacée."
            ),
            // --- Sécurité / SSL ---
            -1200 => new(
                "Connexion non sécurisée (-1200)",
                "Le certificat de sécurité du site n'est pas valide."
            ),
            -1201 => new(
                "Certificat expiré (-1201)",
                "Le certificat de sécurité du site a expiré."
            ),
            -1202 => new(
                "Certificat invalide (-1202)",
                "Le certificat de sécurité du site est invalide."
            ),
            -1203 => new(
                "Certificat non fiable (-1203)",
                "Le certificat de sécurité du site n'est pas approuvé."
            ),
            -1204 => new(
                "Certificat requis (-1204)",
                "Un certificat client est requis pour accéder à cette ressource."
            ),
            // --- Fallback ---
            _ => new(
                $"Erreur de chargement ({errorCode})",
    ...
    public static WebErrorInfo GetHttpErrorInfo(int statusCode)
    {
        return statusCode switch
        {
            ...
            402 => new(
                "Paiement requis",
                "Un paiement est nécessaire pour accéder à cette ressource."
            ),
            403 => new(
                "Accès interdit",
            ...
            406 => new(
                "Non acceptable",
                "La ressource demandée ne peut pas être fournie dans ce format."
            ),
            407 => new(
                "Authentification proxy requise",
                "Une authentification proxy est nécessaire."
            ),
            408 => new(
                "Délai dépassé",
            ...
            410 => new(
                "Ressource supprimée",
                "La ressource demandée a été définitivement supprimée."
            ),
            411 => new(
                "Longueur requise",
                "La requête doit spécifier la longueur du contenu."
            ),
            412 => new(
            ...
            413 => new(
                ...
                "La charge utile dépasse la taille autorisée."
            ),
            414 => new(
                "URI trop longue",
            ...
            415 => new(
                "Type non supporté",
                "Le type de média de la requête n'est pas pris en charge."
            ),
            416 => new(
                "Plage non satisfaisante",
                "La plage demandée n'est pas disponible."
            ),
            417 => new(
                "Attente échouée",
                "Le serveur n'a pas pu satisfaire l'attente demandée."
            ),
            418 => new(
                "Erreur inhabituelle",
            ...
            421 => new(
                "Requête mal dirigée",
                "La requête a été envoyée au mauvais serveur."
            ),
            422 => new(
                "Entité non traitable",
                "Le serveur comprend la requête mais ne peut pas la traiter."
            ),
            423 => new(
            ...
            425 => new(
                "Requête trop précoce",
                "La requête a été envoyée trop tôt."
            ),
            426 => new(
                "Mise à jour requise",
                "Une mise à jour du protocole est requise."
            ),
            428 => new(
                "Précondition requise",
                "Des conditions préalables sont requises."
            ),
            429 => new(
                "Trop de requêtes",
            ...
            431 => new(
                ...
                "Les champs d'en-tête sont trop volumineux."
            ),
            451 => new(
                "Indisponible légalement",
            ...
            501 => new(
                "Non implémenté",
                "Cette fonctionnalité n'est pas prise en charge par le serveur."
            ),
            502 => new(
                "Passerelle incorrecte",
                "Le serveur a reçu une réponse invalide."
            ),
            503 => new(
            ...
            504 => new(
                "Délai serveur dépassé",
                "Le serveur n'a pas répondu à temps."
            ),
            505 => new(
                "Version HTTP non supportée",
                "La version HTTP utilisée n'est pas prise en charge."
            ),
            506 => new(
                "Variation non négociée",
                "Une erreur de négociation de contenu est survenue."
            ),
            507 => new(
                "Stockage insuffisant",
                "Le serveur ne dispose pas de suffisamment d'espace."
            ),
            508 => new(
                "Boucle détectée",
                "Le serveur a détecté une boucle infinie."
            ),
            510 => new(
                "Extension requise",
                "Une extension HTTP est requise."
            ),
            511 => new(
                "Authentification réseau requise",
                "Une authentification réseau est nécessaire."
            ),
            _ => new(
                $"Erreur HTTP {statusCode}",
                "Une erreur HTTP inconnue est survenue."
            )
        };
    }
}
